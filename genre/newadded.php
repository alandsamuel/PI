...
<td>$no</td>
<td>
	<a href='home.php?target=beligame&idgame=".$datagame['idgame']."'>
	<img src='img/bk/".$datagame['gambar']."'width=160 height=88 style='border:1px solid black'></td>
<td><b>".$datagame['judul']."</b></a><br>".$datagame['shortdesc']."
</td>
	<td>Rp.".$datagame['harga']."</td>
<td>
<a class='btn btn-default' href='home.php?target=beligame&idgame=".$datagame['idgame']."' role='button'>BELI</a></td>
</tr>";
}
echo"</table>";
?>
