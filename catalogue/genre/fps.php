...
$querygame = mysql_query("SELECT * FROM game where idkategori='k01'");
...
<tr>
<td>$no</td>
<td><a href='home.php?target=beligame&idgame=".$datagame['idgame']."'><img src='img/bk/".$datagame['gambar']."'width=160 height=88></td>
<td>
".$datagame['judul']."</a></td>
