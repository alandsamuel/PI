...
<body>
	...
	<div id="atas">
		<div class="logo">
			...
			<a href="index.php#contact-section" name="Menu Utama"><b>Hubungi</b></a> |
			<a href="index.php#about-section" name="Menu Utama"><b>Tentang</b></a> 
	</div>
	</div>
	<hr>
    <!-- Page Content -->
		...
		<div class="col-sm-1">
				...
				<?php
					echo "
						...
						<a href='home.php?target=newadded' class='list-group-item'>All Items</a>
